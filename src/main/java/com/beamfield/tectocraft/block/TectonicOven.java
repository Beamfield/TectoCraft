...
public class TectonicOven extends BlockContainer implements IElectricalDevice, IWrenchableDevice, IEnergyConnection{
	...
	// Constructor
	public TectonicOven(boolean isActive) {
		super(Material.iron);
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		...
		this.iconFront = iconRegister.registerIcon(Reference.MODID  + ":" + (this.isActive ? "TectonicOven_front_active" : "TectonicOven_front_idle"));
	...
	public Item getItemDropped(int i, Random random, int j) {
		return Item.getItemFromBlock(TectoCraft.tectoOven_idle);
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityPlayer, ItemStack itemStack) {
		...
		if(itemStack.hasDisplayName()) {}
			((TileEntityTectonicOven)world.getTileEntity(x, y, z)).setGuiDisplayName(itemStack.getDisplayName());
	}


	public void breakBlock(World world, int x, int y, int z, Block oldBlock, int oldMetadata) {
		if(!keepInventory) {
			TileEntityTectonicOven tileEntity = (TileEntityTectonicOven)world.getTileEntity(x, y, z);
	...
	public static void updateForgeOvenBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		if(active) {
			worldObj.setBlock(xCoord, yCoord, zCoord, TectoCraft.tectoOven_active);
		} else {
			worldObj.setBlock(xCoord, yCoord, zCoord, TectoCraft.tectoOven_idle);
		}
