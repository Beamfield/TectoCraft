...
public class TectoCrafterShapedRecipes implements IRecipe {
	...
	public TectoCrafterShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack) {
	...
	public TectoCrafterShapedRecipes func_92100_c() {
